...
form.addEventListener("submit", (e) => {
  ...
  let isNameValid = checkName(),
    ...
    // isServiceValid = checkService(),
    isMessageValid = checkMessage();

  let isFormValid = isNameValid && isEmailValid && isMobileValid && isMessageValid;
  ...
  if (!captchaResponse.length > 0) {
    ...
    status.innerHTML = "Captcha not complete, Please fill the Captcha Code";
